...
export default {
    methods: {
        ...
        getAllViajesFromUsuario(e) {
            crud.getAllViajesFromUsuario(e.target.elements["id"].value)
                .then(response => console.log(response))
                .catch(error => crud.handleError(error));
        },
        getViajeById(e) {
            crud.getViajeById(e.target.elements["id"].value)
                .then(response => console.log(response))
                .catch(error => crud.handleError(error));
        },
        postViaje(e) {
        ...
        putViaje(e) {
            ...
            crud.putViaje(formData)
                .then(response => console.log(response))
                .catch(error => crud.handleError(error));
        },
        deleteViaje(e) {
            crud.deleteViaje(e.target.elements["id"].value)
                .then(response => console.log(response))
                .catch(error => crud.handleError(error));
        },
        ...
        getAllItemsViajeFromViaje(e) {
            crud.getAllItemsViajeFromViaje(e.target.elements["id"].value)
                .then(response => console.log(response))
                .catch(error => crud.handleError(error));
        },
        getItemsViajeById(e) {
            crud.getItemsViajeById(e.target.elements["id"].value)
                .then(response => console.log(response))
                .catch(error => crud.handleError(error));
        },
        postItemsViaje(e) {
        ...
        putItemsViaje(e) {
            ...
            crud.putItemsViaje(formData)
                .then(response => console.log(response))
                .catch(error => crud.handleError(error));
        },
        deleteItemsViaje(e) {
            crud.deleteItemsViaje(e.target.elements["id"].value)
                .then(response => console.log(response))
                .catch(error => crud.handleError(error));
        },
    }
